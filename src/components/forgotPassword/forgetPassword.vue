<template>
    <v-container fluid fill-height class="d-flex align-center justify-center  sign-in-background pa-0">
      <v-card v-if="step === 1" class="elevation-12 sign-in-card fixed" max-width="500" rounded>
      ...
      <v-card v-if="step === 2"  class="elevation-12 sign-in-card fixed" max-width="500" rounded>
        <v-card-title class="mb-3">
         <router-link :to="{name: 'phonebook'}">
           <v-icon color="primary" class="mr-2" large>
            <v-img
      ...
      <v-card v-if="step === 3" class="elevation-12 sign-in-card fixed" max-width="500" rounded>
        <v-card-title class="mb-3">
         <router-link :to="{name: 'phonebook'}">
           <v-icon color="primary" class="mr-2" large>
            <v-img
  ...
  export default {
    data() {
      return {
        ...
        codeRules: {
           //required: (v) => !!v || "Verification code is required",
          // code: (v) => v.length == 6 || "Code must be  6 numbers",
